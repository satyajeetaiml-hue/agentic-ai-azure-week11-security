...
Download the **7-slide deck** for classroom use: [`agentic-ai-azure-week11-security.pptx`](slides/agentic-ai-azure-week11-security.pptx)

Prefer PDF? Download the **handout (slides + speaker notes)**: [`agentic-ai-azure-week11-security-handout.pdf`](slides/agentic-ai-azure-week11-security-handout.pdf)
